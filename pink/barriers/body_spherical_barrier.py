...
class BodySphericalBarrier(Barrier):
    ...
    .. math::
        ...
        \boldsymbol{p}_2(\boldsymbol{q})\|^2 - d_{min}^2

    where :math:`\boldsymbol{p}_1(\boldsymbol{q})` and
    :math:`\boldsymbol{p}_2(\boldsymbol{q})` are the positions of the two
    ...
    def compute_jacobian(self, configuration: Configuration) -> np.ndarray:
        ...
        .. math::
            ...
            \frac{\partial h}{\partial \boldsymbol{q}}(\boldsymbol{q}) =
